        ...
        <div className={module.About__inner}>
          ...
          <section className={module.About__content}>
            <div className={module.About__text}>
              ...
              <p>
                Eu comecei a <em>"brincar"</em> com códigos em meados de 2009 e
                trabalhar profissionalmente em uma agência de criação e
                desenvolvimento web no ano de 2011.
              </p>
              <p>
                Em 2010 comecei o curso de web design na Microcamp{' '}
                <strong>Curitiba</strong> e finalizei em 2012, nesta mesma época
                conclui o curso técnico em informática com ênfase em programação
                no{' '}
                <a
          ...
          <section className={module.About__content}>
            <div className={module.About__text}>
              ...
              <p>
                ...
                , onde blogueiros e proprietários de sites do mundo compartilham
