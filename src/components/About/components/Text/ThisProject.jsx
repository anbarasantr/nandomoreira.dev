...
export const ThisProject = ({ classes }) => (
  <div className={classes.text}>
    ...
    <p>
      ...
      , eu sou o cara que mais muda de layout para blog na face da Terra!), eu o
      uso para fazer meus experimentos malucos, geralmente quando estou a
    ...
    <p>
      ...
      <a href="https://github.com/nandomoreirame/nandomoreira.dev">aqui</a> ,
